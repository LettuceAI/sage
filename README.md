...
`sage` is trained on six openly-licensed datasets. All source licenses permit commercial use, redistribution, and training of models that are publicly released. Attribution for each source is listed in [`DATA_LICENSES.md`](DATA_LICENSES.md).
